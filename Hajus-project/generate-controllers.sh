...
dotnet aspnet-codegenerator controller -name DogsController -actions -m Dog -dc AppDbContext -outDir Controllers --useDefaultLayout --useAsyncActions --referenceScriptLibraries -f
