...
export class Register {
  ...
  // ==================== View methods ================
  submit(): void {
    log.debug("submit", this.email, this.password, this.firstname, this.lastname);
    if (this.password==null || this.firstname == null || this.lastname == null||  this.confirmPassword==null || this.email == null || 
    ...
    this.identityService.register(this.email, this.password, this.firstname, this.firstname)
        .then(jwtDTO => {
